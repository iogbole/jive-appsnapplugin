<#assign pageTitle = "Grabbed Appsnaps">
<html>
<head>
...
<#if executeStatus!="no-dir">
    <#if executeStatus!="no-script">
        <#if executeStatus!="exit-status">
            <#if filelist?has_content>
            <div id="appsnap-table">

                <#if executeStatus="success">
                    <div id="jive-success-box" class="jive-success-box" style="width:300px" aria-live="polite"
                         aria-atomic="true">
                        <span class="jive-icon-med jive-icon-check"></span>
                        <@s.text name="admin.decorator.menu.system.appsnap.success"/>
                    </div>
                    <script type="text/javascript">
                        $j('#jive-success-box').fadeIn(1000).delay(5000).fadeOut();
                    </script>
                </#if>
                <div class="jive-table">
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="padding-left:2px; padding-right:2px;text-align: center"><@s.text name="admin.decorator.menu.system.appsnap.view.file.action"/></th>
                        </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="20%"> <#if flist_index+1=1><span
                                        class="jive-icon-sml jive-icon-check"></span>
                                    <@s.text name="admin.decorator.menu.system.appsnap.view.file.latest"/>
                                    </span><#else><@s.text name="admin.decorator.menu.system.appsnap.view.file.backup"/></#if>
                                </td>
                                <td nowrap style="padding-left:2px; padding-right:2px;" width="40%" align="center">
                                    ...
                                    <@s.param name="filename">${flist?html}</@s.param>
                                            ...
                                            src="../images/arrow-down-blue-16x16.gif" border="0"
                                            alt="Download Appsnap"/></a>
                                    &nbsp;&nbsp;&nbsp;
                                    ...
                                    <form id="appsnap-delete-form-${flist?html}"
                                          name="appsnap-delete-form-${flist?html}"
                                          action="<@s.url action='appsnap-capture' method='deleteFile' />" method="post">
        ...
        <#else>
        <div class="jive-error-box">
            <span class="jive-icon-med jive-icon-redalert"></span>

            <p><b> <@s.text name="admin.decorator.menu.system.appsnap.fail"/></b></p>
        </div>
        </#if>
    ...
    <div class="jive-error-box">
        ...
        <p><b> <@s.text name="admin.decorator.menu.system.appsnap.grab.script.exist"/></b></p>
    </div>
    </#if>
...
<div class="jive-error-box">
    ...
    <p><b> <@s.text name="admin.decorator.menu.system.appsnap.grab.dir.exist"/></b></p>
</div>
</#if>
